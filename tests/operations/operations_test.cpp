...
int main(){
    ...
    // sk::arm input_arm;
    sk::boost input_boost(3,4);// = rand_n<sk_boost>(total_size);
    // input_arm = rand_n<sk::arm>(total_size);
    ...
    // input_arm = rand_n<sk::arm>(total_size*5);
    // auto ans = k_svd(input_arm, 10, 15);
    auto d = sk::ops::gaussian_projection<sk::boost>(input_boost, sketch_size);
    /*
